...
- Elastisitas menunjukkan hubungan antara: % $\Delta$ jumlah diminta dan % $\Delta$ harga. - Fokus kita ke % $\Delta$, satuan terlalu penting disini. 
...
- <span style="color:green"> Inelastic</span>: persentasi perubahan jumlah diminta < persentasi perubahan harga. 
  + the price elasticity has an absolute value less than 1.0
- <span style="color:green">Unit elastic</span>: tpersentasi perubahan jumlah diminta =  persentasi perubahan harga
...
- <span style="color:green">Elastic</span>: A change in price has a relatively large effect on quantity demanded; 
  + persentasi perubahan jumlah diminta > persentasi perubahan harga; 
  + the resulting price elasticity has an absolute value exceeding 1.0

---

## Elastisitas dan Total Penerimana (Total Revenue)
...
- Diukur dengan menghitung: the percentage change in quantity supplied divided by 
